CodeMirror.defineSimpleMode("guqinshorthand", {
  start: [
    {regex: /\/\/.*/, token: "comment"},
    {regex: /jianzipu (.*):|jianzipu:|title:|composer:|timesig:|tuninglabel:|voice:|fyhuirange:|tuning:|temperament:|showtimesig:|showtabs:|showjianzipu:|ly:|bars:|key:|time:|clef:|tempo:|mark:/, token: "keyword"},
    {regex: /n:/, token: "notes"},
